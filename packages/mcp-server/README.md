...
Model Context Protocol server for the Chem toolkit — exposes chemag tooling to MCP-aware clients (Claude Desktop, Cursor, IDE plugins) over stdio. Per-session vocabulary + manifest cache; never depends on @chemag/cli to keep the dep graph acyclic.
